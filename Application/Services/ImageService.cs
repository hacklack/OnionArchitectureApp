   ...
   public class ImageService
    {
        ...
        //    {
        //        throw new ServiceException(ServiceErrorCodes.InvalidPhoto.ToString(), "There is no photo.");
        //    }

        //    if (imageStream.Length > 5120000)
        //    {
        //        throw new ServiceException(ServiceErrorCodes.InvalidPhoto.ToString(), "Photo cannot be bigger than 5120000 bytes.");
        //    }
        ...
        //    {
        //        throw new ServiceException(ServiceErrorCodes.InvalidPhoto.ToString(), "Invalid file format.");
        //    }
